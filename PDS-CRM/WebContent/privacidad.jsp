...
<body>
	<div class="container-fluid">
		...
		<p>&nbsp;</p>
		<p>El presente Política de Privacidad establece los términos en
			que CRM usa y protege la información que es proporcionada por sus
			...
			de Privacidad puede cambiar con el tiempo o ser actualizada por lo
			que le recomendamos y enfatizamos revisar continuamente esta página
		...
		<p>Nuestro sitio web podrá recoger información personal por
			...
			procesar algún pedido o realizar una entrega o facturación.</p>
		<p>
		...
		<p>CRM está altamente comprometido para cumplir con el compromiso
		...
		<p>
			...
			visitas a una web </a>. Usted puede aceptar o negar el uso de cookies,
		...
		<p>CRM Se reserva el derecho de cambiar los términos de la
