...
<title>Terminos y condiciones dfe uso</title>
...
<body>
	<div class="container-fluid">
		...
		<p>Es requisito necesario para la adquisición de los productos que
			...
			presentadas por una página web tercera y en tal caso estarían sujetas
			a sus propios Términos y Condiciones. En algunos casos, para adquirir
			un producto, será necesario el registro por parte del usuario, con
		...
		<p>El usuario puede elegir y cambiar la clave para su acceso de
			...
			nuestros productos. CRM no asume la responsabilidad en caso de que
		...
		<p>Los precios de los productos ofrecidos en esta Tienda Online es
			válido solamente en las compras realizadas en este sitio web.</p>
		<p>
			<strong>LICENCIA</strong>
		</p>
		<p>CRM&nbsp; a través de su sitio web concede una licencia para
		...
		<p>En caso de que aplique (para venta de software, templetes, u
			otro producto de diseño y programación) usted no puede colocar uno de
		...
		<p>En el caso de productos que sean&nbsp; mercancías irrevocables
			...
			normales de los productos y sólo se harán efectivos estos términos si
			el equipo ha sido usado correctamente. Esto incluye:</p>
		<p>
		...
		<p>
			Este CRM garantiza que la información
			...
			pedidos no serán entregados a terceros, salvo que deba ser revelada
		...
		<p>La suscripción a boletines de correos electrónicos
			...
			crear su cuenta.</p>
		<p>CRM reserva los derechos de cambiar o de modificar estos
