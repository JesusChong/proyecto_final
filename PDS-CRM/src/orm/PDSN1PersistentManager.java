...
public class PDSN1PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PDSN1";
	...
	private PDSN1PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PDSN1PersistentManager();
		}
